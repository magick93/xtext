...
public abstract class DomainObjectImpl extends NamedElementImpl implements DomainObject {
	 ...
	 */
	@Override
	public sculptormetamodel.Module getModule() {
		if (eContainerFeatureID() != SculptormetamodelPackage.DOMAIN_OBJECT__MODULE) return null;
		return (sculptormetamodel.Module)eContainer();
	}
	 ...
	 * @generated
	 */
	public sculptormetamodel.Module basicGetModule() {
		if (eContainerFeatureID() != SculptormetamodelPackage.DOMAIN_OBJECT__MODULE) return null;
		return (sculptormetamodel.Module)eInternalContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetModule(sculptormetamodel.Module newModule, NotificationChain msgs) {
	 ...
	 */
	@Override
	public void setModule(sculptormetamodel.Module newModule) {
		if (newModule != eInternalContainer() || (eContainerFeatureID() != SculptormetamodelPackage.DOMAIN_OBJECT__MODULE && newModule != null)) {
			...
			if (newModule != null)
				msgs = ((InternalEObject)newModule).eInverseAdd(this, SculptormetamodelPackage.MODULE__DOMAIN_OBJECTS, sculptormetamodel.Module.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SculptormetamodelPackage.DOMAIN_OBJECT__MODULE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetModule((sculptormetamodel.Module)otherEnd, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case SculptormetamodelPackage.DOMAIN_OBJECT__MODULE:
				return eInternalContainer().eInverseRemove(this, SculptormetamodelPackage.MODULE__DOMAIN_OBJECTS, sculptormetamodel.Module.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SculptormetamodelPackage.DOMAIN_OBJECT__REPOSITORY:
				...
				return;
			case SculptormetamodelPackage.DOMAIN_OBJECT__MODULE:
				setModule((sculptormetamodel.Module)newValue);
				return;
			case SculptormetamodelPackage.DOMAIN_OBJECT__OPTIMISTIC_LOCKING:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case SculptormetamodelPackage.DOMAIN_OBJECT__REPOSITORY:
				...
				return;
			case SculptormetamodelPackage.DOMAIN_OBJECT__MODULE:
				setModule((sculptormetamodel.Module)null);
				return;
			case SculptormetamodelPackage.DOMAIN_OBJECT__OPTIMISTIC_LOCKING:
