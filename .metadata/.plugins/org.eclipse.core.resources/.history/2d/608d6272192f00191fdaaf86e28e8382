...
public class ConsumerImpl extends NamedElementImpl implements Consumer {
	...
	public void setModule(sculptormetamodel.Module newModule) {
		if (newModule != eInternalContainer() || (eContainerFeatureID() != SculptormetamodelPackage.CONSUMER__MODULE && newModule != null)) {
			...
			if (newModule != null)
				msgs = ((InternalEObject)newModule).eInverseAdd(this, SculptormetamodelPackage.MODULE__CONSUMERS, sculptormetamodel.Module.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case SculptormetamodelPackage.CONSUMER__MODULE:
				return eInternalContainer().eInverseRemove(this, SculptormetamodelPackage.MODULE__CONSUMERS, sculptormetamodel.Module.class, msgs);
		}
